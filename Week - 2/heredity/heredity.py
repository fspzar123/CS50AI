...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if mother is None and father is None:
            ...
            if genes == 2:
                gene_probability = mother_gene_prob * father_gene_prob
            elif genes == 1:
                gene_probability = (mother_gene_prob * (1 - father_gene_prob)) + ((1 - mother_gene_prob) * father_gene_prob)
            else:
                gene_probability = (1 - mother_gene_prob) * (1 - father_gene_prob)

        trait_probability = PROBS["trait"][genes][person in have_trait]
        total_prob *= gene_probability * trait_probability
